...
/**
 * Utility methods for building consistent Confluence tool response strings.
 * <p>
 ...
 */
@Component
public class ConfluenceResponseUtil {

    /**
     * Returns a JSON error payload in the standard tool error format.
     *
     * @param tool    the tool name (e.g. {@code "searchContent"})
