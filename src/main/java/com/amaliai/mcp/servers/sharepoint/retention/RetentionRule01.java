...
/** Retention rule 01: decides whether a document class may be purged. */
public class RetentionRule01 {
    ...
    public boolean mayPurge(String documentClass, long ageInDays) {
        ...
        return ageInDays > THRESHOLD_DAYS && documentClass.startsWith("class-01");
    }
